...
import {accountInfoDictionary} from '../../../../shared/contstants/suggestion-dictionary';

@Component({
    selector: 'app-suggestion-account-info',
    templateUrl: './suggestion-account-info.component.html',
    styleUrls: ['./suggestion-account-info.component.scss']
})
export class SuggestionAccountInfoComponent implements OnInit {

    @Input() suggestionInfo;

    dictionary: {} = accountInfoDictionary;
    applicantData = [];
